...
<form name="frm-jcrop" id="frm-jcrop" method="POST" action="bd/crop_empresa.php" enctype="multipart/form-data">
    ...
    <div class="inner-wrap">
        ...
        <label>Nome do Representante <input type="text" name="nome_do_usuario" required autofocus  maxlength="40"/ value="<?= $row['USER_NOME'] ?>"></label>
        
        <label>Nome da Empresa <input type="text" name="nome_da_empresa" required autofocus  maxlength="100"/ value="<?= $row['USER_EMPRESA'] ?>"></label>
        
        <label>Descrição da Empresa<textarea name="descricao" required autofocus  maxlength="5000"><?= $row['USER_DESCRICAO'] ?></textarea></label>
        
        <label>CEP <input  type="text" name="cep" id="cep" required value="<?= $row['USER_CEP'] ?>"></label>

        <label>Número da Rua<input disabled="true" type="text" name="numero" id="numero" required></label>


        <label>Logradouro <input disabled="true" type="text" name="logradouro_da_empresa" id="rua" required autofocus  maxlength="45" value="<?= $row['USER_LOGRADOURO'] ?>" /></label>

        <label>Bairro <input disabled="true" type="text" name="bairro" id="bairro" required value="<?= $row['USER_BAIRRO'] ?>"></label>

        <label>Cidade <input disabled="true" type="text" name="cidade_da_empresa" id="cidade" required autofocus  maxlength="25" value="<?= $row['USER_CIDADE'] ?>" /></label>
        
        <label>Estado <input disabled="true" type="text" name="estado" id="uf" required value="<?= $row['USER_ESTADO'] ?>"></label>
